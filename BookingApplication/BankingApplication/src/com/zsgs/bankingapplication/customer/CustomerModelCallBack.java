...
public interface CustomerModelCallBack {
	...
	void addNewCustomer(String customerId,String name, int age, String phoneNumber, String aadharNumber);

	void checkValidCustomer(String id, String password);

	void resetLoginPassword(String customerId, String password);
